...
class CustomUIGrid extends BaseCustomUI {
  static AppearanceTab = props => {
    return <Form fields={appearanceFields} onSubmit={() => {}} />;
  };

  static ConditionalTab = props => {
    return <Form fields={conditionalFields} onSubmit={() => {}} />;
  };
  ...
  static TransitionsTab = props => {
    return (
      <div>
        ...
        <Form fields={transitionFields} onSubmit={() => {}} />
      </div>
    );
  };
}

export default CustomUIGrid;
